...
public class Window extends JFrame{
	...
	private void initPanels(){
		...
		setVisible(true);
		/*try {
			File m = new File("./resources/zelda.wav");
			AudioFileFormat aff=AudioSystem.getAudioFileFormat(m);
			AudioInputStream ais=AudioSystem.getAudioInputStream(m);
	...
	public void refreshPanel(){
		for(int i=0; i<game.getDesk().getHeigth(); i++){
			for(int j=0; j<game.getDesk().getWidth(); j++){
